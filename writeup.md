...
We also didn't do much for detecting coverage so we have little knowledge of what code paths are actually covered in the binary. We did however design our mutation to theoretically hit many code paths.
